...
**Generated:** 2024  
**Target Stack:** Java 21 + Spring Boot 3.3.x (backend) | Existing `src/frontend-react` React + TypeScript + Vite stack using repository-configured versions (frontend) | Mock Repository (POC)
