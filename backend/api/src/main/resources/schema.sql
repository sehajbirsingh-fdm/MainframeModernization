...
CREATE TABLE IF NOT EXISTS PROCTRAN (
  PROCTRAN_EYECATCHER CHAR(4),
  PROCTRAN_SORTCODE CHAR(6) NOT NULL,
  PROCTRAN_NUMBER CHAR(8) NOT NULL,
  PROCTRAN_DATE CHAR(8) NOT NULL,
  PROCTRAN_TIME CHAR(6) NOT NULL,
  PROCTRAN_REF CHAR(12) NOT NULL,
  PROCTRAN_TYPE CHAR(3) NOT NULL,
  PROCTRAN_DESC CHAR(40) NOT NULL,
  PROCTRAN_AMOUNT DECIMAL(12,2) NOT NULL,
  PRIMARY KEY (PROCTRAN_SORTCODE, PROCTRAN_NUMBER, PROCTRAN_DATE, PROCTRAN_TIME, PROCTRAN_REF)
);
